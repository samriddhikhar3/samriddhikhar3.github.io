...
categories:
  ...
  - Pollution
  - Machine Learning
subtitle: 'A project using machine learning, environmental data, and [Philadelphia L&I Building and Zoning Permits](https://data.phila.gov/visualizations/li-building-permits) to forecast development.'
about:
  id: hero-heading
  image-width: 0em
  template: solana
